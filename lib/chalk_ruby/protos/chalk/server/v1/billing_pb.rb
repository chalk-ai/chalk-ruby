...
require 'chalk_ruby/protos/chalk/kubernetes/v1/nodes_pb'
require 'chalk_ruby/protos/chalk/kubernetes/v1/pods_pb'
require 'chalk_ruby/protos/chalk/pubsub/v1/node_status_pb'
require 'chalk_ruby/protos/chalk/pubsub/v1/pod_status_pb'
require 'chalk_ruby/protos/chalk/server/v1/chart_pb'
require 'chalk_ruby/protos/chalk/server/v1/pod_request_pb'
require 'chalk_ruby/protos/chalk/usage/v1/rate_pb'
...
module Chalk
  module Server
    module V1
      ...
      GetNodesAndPodsUIRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("chalk.server.v1.GetNodesAndPodsUIRequest").msgclass
      GetNodesAndPodsUIResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("chalk.server.v1.GetNodesAndPodsUIResponse").msgclass
